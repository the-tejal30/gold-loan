...
//     { label: "Locations", value: "Telangana" },
//   ];
...
import "./HeroSection.css";
import { ChevronRightIcon } from "@/icons/ChevronRightIcon";
import { sendToGoogleSheets } from "@/integrations/api";
...
const HeroSection = () => {
  ...
  const handleViewRates = async (e: React.FormEvent) => {
    e.preventDefault();
    await sendToGoogleSheets({ mobileNumber }, 'mobile');
    navigate("/live-gold-rate");
  };
            ...
            <div className="hero-rate-container">
              ...
              <div className="hero-rate-card">
                <div className="hero-rate-content">
                  ...
                  <form onSubmit={handleViewRates} className="hero-rate-form">
                    <input
                      type="tel"
                      placeholder="Enter mobile number"
                      value={mobileNumber}
